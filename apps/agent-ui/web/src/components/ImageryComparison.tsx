...
export function ImageryComparison({
  ...
  const option = useMemo<EChartsOption>(() => ({
    ...
    legend: {
      top: 2,
      right: 12,
      textStyle: { color: "#a9b2c3", fontSize: 11 },
      itemWidth: 14,
      itemHeight: 8,
    },
    tooltip: {
      trigger: "axis",
      axisPointer: { type: "shadow", shadowStyle: { color: "rgba(151,176,214,.08)" } },
    ...
    xAxis: {
      ...
      axisTick: { show: false },
      axisLine: { lineStyle: { color: "#2e3b56" } },
      axisLabel: { color: "#c9c2ad", fontFamily: "Microsoft YaHei", fontSize: 12 },
    },
    yAxis: {
      type: "value",
      name: "每万字率",
      nameTextStyle: { color: "#77809a", fontSize: 11 },
      axisLabel: { color: "#77809a", fontSize: 10 },
      splitLine: { lineStyle: { color: "rgba(151,176,214,.1)" } },
    },
    series: [
      {
        name: "唐",
