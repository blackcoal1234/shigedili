...
<header class="topbar">
  <div class="wrap">
    <div class="title-row">
    <div><div class="eyebrow">诗行万里 · 38</div><h1>唐宋意象潮汐<span class="dot">。</span></h1></div>
...
<footer>
  <div class="wrap">
<nav class="site-nav" aria-label="作品页面导航">
  ...
  <div>诗行万里 · 唐宋诗歌数字可视化 · 本页离线生成，统计口径、逐篇系年来源与证据审计见“方法、排除与证据审计”。</div>
  </div>
</footer>
'''
